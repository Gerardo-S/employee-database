...
SELECT e.id, e.first_name, e.last_name, employee_role.title, department.department_name As department, employee_role.salary, CONCAT(m.first_name, " ", m.last_name) AS manager
